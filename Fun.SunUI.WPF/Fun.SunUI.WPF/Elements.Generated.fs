...
type UIElementBuilder<'Element when 'Element :> System.Windows.UIElement>() =
    ...
    [<CustomOperation("InputBindingsEx")>] member inline this.InputBindingsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.InputBindings), x)
    [<CustomOperation("InputBindingsEx'")>] member inline this.InputBindingsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.InputBindings), x)
    [<CustomOperation("InputBindings")>] member inline this.InputBindings ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.InputBindings), x)
    [<CustomOperation("InputBindings'")>] member inline this.InputBindings' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.InputBindings), x)
    [<CustomOperation("CommandBindingsEx")>] member inline this.CommandBindingsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.CommandBindings), x)
    [<CustomOperation("CommandBindingsEx'")>] member inline this.CommandBindingsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.CommandBindings), x)
    [<CustomOperation("CommandBindings")>] member inline this.CommandBindings ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.CommandBindings), x)
    [<CustomOperation("CommandBindings'")>] member inline this.CommandBindings' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.CommandBindings), x)
    ...
    [<CustomOperation("TouchesCapturedEx")>] member inline this.TouchesCapturedEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.TouchesCaptured), x)
    [<CustomOperation("TouchesCapturedEx'")>] member inline this.TouchesCapturedEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.TouchesCaptured), x)
    [<CustomOperation("TouchesCaptured")>] member inline this.TouchesCaptured ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.TouchesCaptured), x)
    [<CustomOperation("TouchesCaptured'")>] member inline this.TouchesCaptured' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.TouchesCaptured), x)
    [<CustomOperation("TouchesCapturedWithinEx")>] member inline this.TouchesCapturedWithinEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.TouchesCapturedWithin), x)
    [<CustomOperation("TouchesCapturedWithinEx'")>] member inline this.TouchesCapturedWithinEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.TouchesCapturedWithin), x)
    [<CustomOperation("TouchesCapturedWithin")>] member inline this.TouchesCapturedWithin ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.TouchesCapturedWithin), x)
    [<CustomOperation("TouchesCapturedWithin'")>] member inline this.TouchesCapturedWithin' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.TouchesCapturedWithin), x)
    [<CustomOperation("TouchesOverEx")>] member inline this.TouchesOverEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.TouchesOver), x)
    [<CustomOperation("TouchesOverEx'")>] member inline this.TouchesOverEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.TouchesOver), x)
    [<CustomOperation("TouchesOver")>] member inline this.TouchesOver ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.TouchesOver), x)
    [<CustomOperation("TouchesOver'")>] member inline this.TouchesOver' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.TouchesOver), x)
    [<CustomOperation("TouchesDirectlyOverEx")>] member inline this.TouchesDirectlyOverEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.TouchesDirectlyOver), x)
    [<CustomOperation("TouchesDirectlyOverEx'")>] member inline this.TouchesDirectlyOverEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.TouchesDirectlyOver), x)
    [<CustomOperation("TouchesDirectlyOver")>] member inline this.TouchesDirectlyOver ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.TouchesDirectlyOver), x)
    [<CustomOperation("TouchesDirectlyOver'")>] member inline this.TouchesDirectlyOver' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.TouchesDirectlyOver), x)
...
type GridViewColumnHeaderBuilder<'Element when 'Element :> System.Windows.Controls.GridViewColumnHeader>() =
    ...
    [<CustomOperation("ColumnEx")>] member inline this.ColumnEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Column), x)
    [<CustomOperation("ColumnEx'")>] member inline this.ColumnEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Column), x)
    [<CustomOperation("Column")>] member inline this.Column ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Column), x)
    [<CustomOperation("Column'")>] member inline this.Column' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Column), x)
...
type DataGridColumnHeaderBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.DataGridColumnHeader>() =
    ...
    [<CustomOperation("SortDirectionEx")>] member inline this.SortDirectionEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SortDirection), x)
    [<CustomOperation("SortDirectionEx'")>] member inline this.SortDirectionEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SortDirection), x)
    [<CustomOperation("SortDirection")>] member inline this.SortDirection ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SortDirection), x)
    [<CustomOperation("SortDirection'")>] member inline this.SortDirection' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SortDirection), x)
...
type NavigationWindowBuilder<'Element when 'Element :> System.Windows.Navigation.NavigationWindow>() =
    ...
    [<CustomOperation("NavigationServiceEx")>] member inline this.NavigationServiceEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.NavigationService), x)
    [<CustomOperation("NavigationServiceEx'")>] member inline this.NavigationServiceEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.NavigationService), x)
    [<CustomOperation("NavigationService")>] member inline this.NavigationService ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.NavigationService), x)
    [<CustomOperation("NavigationService'")>] member inline this.NavigationService' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.NavigationService), x)
    [<CustomOperation("BackStackEx")>] member inline this.BackStackEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.BackStack), x)
    [<CustomOperation("BackStackEx'")>] member inline this.BackStackEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.BackStack), x)
    [<CustomOperation("BackStack")>] member inline this.BackStack ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.BackStack), x)
    [<CustomOperation("BackStack'")>] member inline this.BackStack' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.BackStack), x)
    [<CustomOperation("ForwardStackEx")>] member inline this.ForwardStackEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ForwardStack), x)
    [<CustomOperation("ForwardStackEx'")>] member inline this.ForwardStackEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ForwardStack), x)
    [<CustomOperation("ForwardStack")>] member inline this.ForwardStack ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ForwardStack), x)
    [<CustomOperation("ForwardStack'")>] member inline this.ForwardStack' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ForwardStack), x)
    ...
    [<CustomOperation("CurrentSourceEx")>] member inline this.CurrentSourceEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.CurrentSource), x)
    [<CustomOperation("CurrentSourceEx'")>] member inline this.CurrentSourceEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.CurrentSource), x)
    [<CustomOperation("CurrentSource")>] member inline this.CurrentSource ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.CurrentSource), x)
    [<CustomOperation("CurrentSource'")>] member inline this.CurrentSource' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.CurrentSource), x)
...
type ItemsControlBuilder<'Element when 'Element :> System.Windows.Controls.ItemsControl>() =
    ...
    [<CustomOperation("GroupStyleEx")>] member inline this.GroupStyleEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.GroupStyle), x)
    [<CustomOperation("GroupStyleEx'")>] member inline this.GroupStyleEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.GroupStyle), x)
    [<CustomOperation("GroupStyle")>] member inline this.GroupStyle ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.GroupStyle), x)
    [<CustomOperation("GroupStyle'")>] member inline this.GroupStyle' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.GroupStyle), x)
...
type DataGridBuilder<'Element when 'Element :> System.Windows.Controls.DataGrid>() =
    ...
    [<CustomOperation("RowValidationRulesEx")>] member inline this.RowValidationRulesEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.RowValidationRules), x)
    [<CustomOperation("RowValidationRulesEx'")>] member inline this.RowValidationRulesEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.RowValidationRules), x)
    [<CustomOperation("RowValidationRules")>] member inline this.RowValidationRules ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.RowValidationRules), x)
    [<CustomOperation("RowValidationRules'")>] member inline this.RowValidationRules' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.RowValidationRules), x)
    ...
    [<CustomOperation("NewItemMarginEx")>] member inline this.NewItemMarginEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.NewItemMargin), x)
    [<CustomOperation("NewItemMarginEx'")>] member inline this.NewItemMarginEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.NewItemMargin), x)
    [<CustomOperation("NewItemMargin")>] member inline this.NewItemMargin ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.NewItemMargin), x)
    [<CustomOperation("NewItemMargin'")>] member inline this.NewItemMargin' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.NewItemMargin), x)
...
type ComboBoxBuilder<'Element when 'Element :> System.Windows.Controls.ComboBox>() =
    ...
    [<CustomOperation("IsReadOnly")>] member inline this.IsReadOnly ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.Boolean) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.IsReadOnly), (fun ctx x -> ctx.Element.IsReadOnly <- x), x)
    [<CustomOperation("IsReadOnly")>] member inline this.IsReadOnly ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.IsReadOnly), (fun ctx x -> ctx.Element.IsReadOnly <- x), x)
    [<CustomOperation("SelectionBoxItemEx")>] member inline this.SelectionBoxItemEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectionBoxItem), x)
    [<CustomOperation("SelectionBoxItemEx'")>] member inline this.SelectionBoxItemEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectionBoxItem), x)
    [<CustomOperation("SelectionBoxItem")>] member inline this.SelectionBoxItem ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectionBoxItem), x)
    [<CustomOperation("SelectionBoxItem'")>] member inline this.SelectionBoxItem' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectionBoxItem), x)
    [<CustomOperation("SelectionBoxItemTemplateEx")>] member inline this.SelectionBoxItemTemplateEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectionBoxItemTemplate), x)
    [<CustomOperation("SelectionBoxItemTemplateEx'")>] member inline this.SelectionBoxItemTemplateEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectionBoxItemTemplate), x)
    [<CustomOperation("SelectionBoxItemTemplate")>] member inline this.SelectionBoxItemTemplate ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectionBoxItemTemplate), x)
    [<CustomOperation("SelectionBoxItemTemplate'")>] member inline this.SelectionBoxItemTemplate' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectionBoxItemTemplate), x)
    [<CustomOperation("SelectionBoxItemStringFormatEx")>] member inline this.SelectionBoxItemStringFormatEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectionBoxItemStringFormat), x)
    [<CustomOperation("SelectionBoxItemStringFormatEx'")>] member inline this.SelectionBoxItemStringFormatEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectionBoxItemStringFormat), x)
    [<CustomOperation("SelectionBoxItemStringFormat")>] member inline this.SelectionBoxItemStringFormat ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectionBoxItemStringFormat), x)
    [<CustomOperation("SelectionBoxItemStringFormat'")>] member inline this.SelectionBoxItemStringFormat' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectionBoxItemStringFormat), x)
...
type TabControlBuilder<'Element when 'Element :> System.Windows.Controls.TabControl>() =
    ...
    [<CustomOperation("SelectedContentTemplateSelectorEx")>] member inline this.SelectedContentTemplateSelectorEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectedContentTemplateSelector), x)
    [<CustomOperation("SelectedContentTemplateSelectorEx'")>] member inline this.SelectedContentTemplateSelectorEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectedContentTemplateSelector), x)
    [<CustomOperation("SelectedContentTemplateSelector")>] member inline this.SelectedContentTemplateSelector ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectedContentTemplateSelector), x)
    [<CustomOperation("SelectedContentTemplateSelector'")>] member inline this.SelectedContentTemplateSelector' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectedContentTemplateSelector), x)
    [<CustomOperation("SelectedContentStringFormatEx")>] member inline this.SelectedContentStringFormatEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectedContentStringFormat), x)
    [<CustomOperation("SelectedContentStringFormatEx'")>] member inline this.SelectedContentStringFormatEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectedContentStringFormat), x)
    [<CustomOperation("SelectedContentStringFormat")>] member inline this.SelectedContentStringFormat ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectedContentStringFormat), x)
    [<CustomOperation("SelectedContentStringFormat'")>] member inline this.SelectedContentStringFormat' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectedContentStringFormat), x)
    [<CustomOperation("ContentTemplate")>] member inline this.ContentTemplate ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.Windows.DataTemplate) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.ContentTemplate), (fun ctx x -> ctx.Element.ContentTemplate <- x), x)
    [<CustomOperation("ContentTemplate")>] member inline this.ContentTemplate ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.ContentTemplate), (fun ctx x -> ctx.Element.ContentTemplate <- x), x)
    [<CustomOperation("ContentTemplateSelector")>] member inline this.ContentTemplateSelector ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.Windows.Controls.DataTemplateSelector) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.ContentTemplateSelector), (fun ctx x -> ctx.Element.ContentTemplateSelector <- x), x)
    [<CustomOperation("ContentTemplateSelector")>] member inline this.ContentTemplateSelector ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.ContentTemplateSelector), (fun ctx x -> ctx.Element.ContentTemplateSelector <- x), x)
...
type TreeViewBuilder<'Element when 'Element :> System.Windows.Controls.TreeView>() =
    ...
    [<CustomOperation("SelectedValueEx")>] member inline this.SelectedValueEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SelectedValue), x)
    [<CustomOperation("SelectedValueEx'")>] member inline this.SelectedValueEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SelectedValue), x)
    [<CustomOperation("SelectedValue")>] member inline this.SelectedValue ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SelectedValue), x)
    [<CustomOperation("SelectedValue'")>] member inline this.SelectedValue' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SelectedValue), x)
    [<CustomOperation("SelectedValuePath")>] member inline this.SelectedValuePath ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.String) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.SelectedValuePath), (fun ctx x -> ctx.Element.SelectedValuePath <- x), x)
    [<CustomOperation("SelectedValuePath")>] member inline this.SelectedValuePath ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.SelectedValuePath), (fun ctx x -> ctx.Element.SelectedValuePath <- x), x)
...
type DataGridCellsPresenterBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.DataGridCellsPresenter>() =
    ...
    [<CustomOperation("ItemEx")>] member inline this.ItemEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Item), x)
    [<CustomOperation("ItemEx'")>] member inline this.ItemEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Item), x)
    [<CustomOperation("Item")>] member inline this.Item ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Item), x)
    [<CustomOperation("Item'")>] member inline this.Item' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Item), x)
...
type TextBoxBaseBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.TextBoxBase>() =
    ...
    [<CustomOperation("SpellCheckEx")>] member inline this.SpellCheckEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SpellCheck), x)
    [<CustomOperation("SpellCheckEx'")>] member inline this.SpellCheckEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SpellCheck), x)
    [<CustomOperation("SpellCheck")>] member inline this.SpellCheck ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SpellCheck), x)
    [<CustomOperation("SpellCheck'")>] member inline this.SpellCheck' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SpellCheck), x)
    [<CustomOperation("HorizontalScrollBarVisibility")>] member inline this.HorizontalScrollBarVisibility ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.Windows.Controls.ScrollBarVisibility) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.HorizontalScrollBarVisibility), (fun ctx x -> ctx.Element.HorizontalScrollBarVisibility <- x), x)
    [<CustomOperation("HorizontalScrollBarVisibility")>] member inline this.HorizontalScrollBarVisibility ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.HorizontalScrollBarVisibility), (fun ctx x -> ctx.Element.HorizontalScrollBarVisibility <- x), x)
    [<CustomOperation("VerticalScrollBarVisibility")>] member inline this.VerticalScrollBarVisibility ([<InlineIfLambda>] builder: BuildElement<'Element>, x: System.Windows.Controls.ScrollBarVisibility) = this.MakeEqualityPropertyBuilder(builder, (fun ctx -> ctx.Element.VerticalScrollBarVisibility), (fun ctx x -> ctx.Element.VerticalScrollBarVisibility <- x), x)
    [<CustomOperation("VerticalScrollBarVisibility")>] member inline this.VerticalScrollBarVisibility ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.VerticalScrollBarVisibility), (fun ctx x -> ctx.Element.VerticalScrollBarVisibility <- x), x)
...
type TextBoxBuilder<'Element when 'Element :> System.Windows.Controls.TextBox>() =
    ...
    [<CustomOperation("TypographyEx")>] member inline this.TypographyEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Typography), x)
    [<CustomOperation("TypographyEx'")>] member inline this.TypographyEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Typography), x)
    [<CustomOperation("Typography")>] member inline this.Typography ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Typography), x)
    [<CustomOperation("Typography'")>] member inline this.Typography' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Typography), x)
...
type RichTextBoxBuilder<'Element when 'Element :> System.Windows.Controls.RichTextBox>() =
    ...
    [<CustomOperation("SelectionEx")>] member inline this.SelectionEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Selection), x)
    [<CustomOperation("SelectionEx'")>] member inline this.SelectionEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Selection), x)
    [<CustomOperation("Selection")>] member inline this.Selection ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Selection), x)
    [<CustomOperation("Selection'")>] member inline this.Selection' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Selection), x)
...
type DocumentViewerBaseBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.DocumentViewerBase>() =
    ...
    [<CustomOperation("Document")>] member inline this.Document ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeAdaptivePropertyBuilder(builder, (fun ctx -> ctx.Element.Document), (fun ctx x -> ctx.Element.Document <- x), x)
    [<CustomOperation("PageViewsEx")>] member inline this.PageViewsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.PageViews), x)
    [<CustomOperation("PageViewsEx'")>] member inline this.PageViewsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.PageViews), x)
    [<CustomOperation("PageViews")>] member inline this.PageViews ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.PageViews), x)
    [<CustomOperation("PageViews'")>] member inline this.PageViews' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.PageViews), x)
...
type ScrollBarBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.ScrollBar>() =
    ...
    [<CustomOperation("TrackEx")>] member inline this.TrackEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Track), x)
    [<CustomOperation("TrackEx'")>] member inline this.TrackEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Track), x)
    [<CustomOperation("Track")>] member inline this.Track ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Track), x)
    [<CustomOperation("Track'")>] member inline this.Track' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Track), x)
...
type StickyNoteControlBuilder() =
    ...
    [<CustomOperation("AuthorEx")>] member inline this.AuthorEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Author), x)
    [<CustomOperation("AuthorEx'")>] member inline this.AuthorEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Author), x)
    [<CustomOperation("Author")>] member inline this.Author ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Author), x)
    [<CustomOperation("Author'")>] member inline this.Author' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Author), x)
    ...
    [<CustomOperation("AnchorInfoEx")>] member inline this.AnchorInfoEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.AnchorInfo), x)
    [<CustomOperation("AnchorInfoEx'")>] member inline this.AnchorInfoEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.AnchorInfo), x)
    [<CustomOperation("AnchorInfo")>] member inline this.AnchorInfo ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.AnchorInfo), x)
    [<CustomOperation("AnchorInfo'")>] member inline this.AnchorInfo' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.StickyNoteControl>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.AnchorInfo), x)
...
type PasswordBoxBuilder() =
    ...
    [<CustomOperation("SecurePasswordEx")>] member inline this.SecurePasswordEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.PasswordBox>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.SecurePassword), x)
    [<CustomOperation("SecurePasswordEx'")>] member inline this.SecurePasswordEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.PasswordBox>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.SecurePassword), x)
    [<CustomOperation("SecurePassword")>] member inline this.SecurePassword ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.PasswordBox>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.SecurePassword), x)
    [<CustomOperation("SecurePassword'")>] member inline this.SecurePassword' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.PasswordBox>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.SecurePassword), x)
...
type GridBuilder<'Element when 'Element :> System.Windows.Controls.Grid>() =
    ...
    [<CustomOperation("ColumnDefinitionsEx")>] member inline this.ColumnDefinitionsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ColumnDefinitions), x)
    [<CustomOperation("ColumnDefinitionsEx'")>] member inline this.ColumnDefinitionsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ColumnDefinitions), x)
    [<CustomOperation("ColumnDefinitions")>] member inline this.ColumnDefinitions ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ColumnDefinitions), x)
    [<CustomOperation("ColumnDefinitions'")>] member inline this.ColumnDefinitions' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ColumnDefinitions), x)
    [<CustomOperation("RowDefinitionsEx")>] member inline this.RowDefinitionsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.RowDefinitions), x)
    [<CustomOperation("RowDefinitionsEx'")>] member inline this.RowDefinitionsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.RowDefinitions), x)
    [<CustomOperation("RowDefinitions")>] member inline this.RowDefinitions ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.RowDefinitions), x)
    [<CustomOperation("RowDefinitions'")>] member inline this.RowDefinitions' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.RowDefinitions), x)
...
type WebBrowserBuilder() =
    ...
    [<CustomOperation("DocumentEx")>] member inline this.DocumentEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.WebBrowser>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Document), x)
    [<CustomOperation("DocumentEx'")>] member inline this.DocumentEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.WebBrowser>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Document), x)
    [<CustomOperation("Document")>] member inline this.Document ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.WebBrowser>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Document), x)
    [<CustomOperation("Document'")>] member inline this.Document' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.WebBrowser>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Document), x)
...
type ShapeBuilder<'Element when 'Element :> System.Windows.Shapes.Shape>() =
    ...
    [<CustomOperation("GeometryTransformEx")>] member inline this.GeometryTransformEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransformEx'")>] member inline this.GeometryTransformEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform")>] member inline this.GeometryTransform ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform'")>] member inline this.GeometryTransform' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.GeometryTransform), x)
...
type EllipseBuilder() =
    ...
    [<CustomOperation("RenderedGeometryEx")>] member inline this.RenderedGeometryEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometryEx'")>] member inline this.RenderedGeometryEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometry")>] member inline this.RenderedGeometry ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometry'")>] member inline this.RenderedGeometry' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("GeometryTransformEx")>] member inline this.GeometryTransformEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransformEx'")>] member inline this.GeometryTransformEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform")>] member inline this.GeometryTransform ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform'")>] member inline this.GeometryTransform' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Ellipse>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.GeometryTransform), x)
...
type RectangleBuilder() =
    ...
    [<CustomOperation("RenderedGeometryEx")>] member inline this.RenderedGeometryEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometryEx'")>] member inline this.RenderedGeometryEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometry")>] member inline this.RenderedGeometry ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("RenderedGeometry'")>] member inline this.RenderedGeometry' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.RenderedGeometry), x)
    [<CustomOperation("GeometryTransformEx")>] member inline this.GeometryTransformEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransformEx'")>] member inline this.GeometryTransformEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform")>] member inline this.GeometryTransform ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.GeometryTransform), x)
    [<CustomOperation("GeometryTransform'")>] member inline this.GeometryTransform' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Shapes.Rectangle>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.GeometryTransform), x)
...
type ScrollContentPresenterBuilder() =
    ...
    [<CustomOperation("AdornerLayerEx")>] member inline this.AdornerLayerEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.ScrollContentPresenter>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.AdornerLayer), x)
    [<CustomOperation("AdornerLayerEx'")>] member inline this.AdornerLayerEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.ScrollContentPresenter>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.AdornerLayer), x)
    [<CustomOperation("AdornerLayer")>] member inline this.AdornerLayer ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.ScrollContentPresenter>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.AdornerLayer), x)
    [<CustomOperation("AdornerLayer'")>] member inline this.AdornerLayer' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Controls.ScrollContentPresenter>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.AdornerLayer), x)
...
type AdornerBuilder<'Element when 'Element :> System.Windows.Documents.Adorner>() =
    ...
    [<CustomOperation("AdornedElementEx")>] member inline this.AdornedElementEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.AdornedElement), x)
...
type PageContentBuilder() =
    ...
    [<CustomOperation("LinkTargetsEx")>] member inline this.LinkTargetsEx ([<InlineIfLambda>] builder: BuildElement<System.Windows.Documents.PageContent>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.LinkTargets), x)
    [<CustomOperation("LinkTargetsEx'")>] member inline this.LinkTargetsEx' ([<InlineIfLambda>] builder: BuildElement<System.Windows.Documents.PageContent>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.LinkTargets), x)
...
type MediaElementBuilder<'Element when 'Element :> System.Windows.Controls.MediaElement>() =
    ...
    [<CustomOperation("NaturalDurationEx")>] member inline this.NaturalDurationEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.NaturalDuration), x)
    [<CustomOperation("NaturalDurationEx'")>] member inline this.NaturalDurationEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.NaturalDuration), x)
    [<CustomOperation("NaturalDuration")>] member inline this.NaturalDuration ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.NaturalDuration), x)
    [<CustomOperation("NaturalDuration'")>] member inline this.NaturalDuration' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.NaturalDuration), x)
...
type TextBlockBuilder<'Element when 'Element :> System.Windows.Controls.TextBlock>() =
    ...
    [<CustomOperation("InlinesEx")>] member inline this.InlinesEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Inlines), x)
    [<CustomOperation("InlinesEx'")>] member inline this.InlinesEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Inlines), x)
    [<CustomOperation("Inlines")>] member inline this.Inlines ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Inlines), x)
    [<CustomOperation("Inlines'")>] member inline this.Inlines' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Inlines), x)
    [<CustomOperation("ContentStartEx")>] member inline this.ContentStartEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ContentStart), x)
    [<CustomOperation("ContentStartEx'")>] member inline this.ContentStartEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ContentStart), x)
    [<CustomOperation("ContentStart")>] member inline this.ContentStart ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ContentStart), x)
    [<CustomOperation("ContentStart'")>] member inline this.ContentStart' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ContentStart), x)
    [<CustomOperation("ContentEndEx")>] member inline this.ContentEndEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ContentEnd), x)
    [<CustomOperation("ContentEndEx'")>] member inline this.ContentEndEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ContentEnd), x)
    [<CustomOperation("ContentEnd")>] member inline this.ContentEnd ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ContentEnd), x)
    [<CustomOperation("ContentEnd'")>] member inline this.ContentEnd' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ContentEnd), x)
    [<CustomOperation("TypographyEx")>] member inline this.TypographyEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Typography), x)
    [<CustomOperation("TypographyEx'")>] member inline this.TypographyEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Typography), x)
    [<CustomOperation("Typography")>] member inline this.Typography ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Typography), x)
    [<CustomOperation("Typography'")>] member inline this.Typography' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Typography), x)
...
type ToolBarTrayBuilder<'Element when 'Element :> System.Windows.Controls.ToolBarTray>() =
    ...
    [<CustomOperation("ToolBarsEx")>] member inline this.ToolBarsEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ToolBars), x)
    [<CustomOperation("ToolBarsEx'")>] member inline this.ToolBarsEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ToolBars), x)
    [<CustomOperation("ToolBars")>] member inline this.ToolBars ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ToolBars), x)
    [<CustomOperation("ToolBars'")>] member inline this.ToolBars' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ToolBars), x)
...
type DocumentPageViewBuilder<'Element when 'Element :> System.Windows.Controls.Primitives.DocumentPageView>() =
    ...
    [<CustomOperation("DocumentPageEx")>] member inline this.DocumentPageEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.DocumentPage), x)
    [<CustomOperation("DocumentPageEx'")>] member inline this.DocumentPageEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.DocumentPage), x)
    [<CustomOperation("DocumentPage")>] member inline this.DocumentPage ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.DocumentPage), x)
    [<CustomOperation("DocumentPage'")>] member inline this.DocumentPage' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.DocumentPage), x)
