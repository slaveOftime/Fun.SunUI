...
type WindowBaseBuilder<'Element when 'Element :> Modern.Forms.WindowBase>() =
    ...
    [<CustomOperation("LocationEx")>] member inline this.LocationEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Location), x)
    [<CustomOperation("LocationEx'")>] member inline this.LocationEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Location), x)
    [<CustomOperation("Location")>] member inline this.Location ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Location), x)
    [<CustomOperation("Location'")>] member inline this.Location' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Location), x)
    ...
    [<CustomOperation("ScaledDisplayRectangleEx")>] member inline this.ScaledDisplayRectangleEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.ScaledDisplayRectangle), x)
    [<CustomOperation("ScaledDisplayRectangleEx'")>] member inline this.ScaledDisplayRectangleEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.ScaledDisplayRectangle), x)
    [<CustomOperation("ScaledDisplayRectangle")>] member inline this.ScaledDisplayRectangle ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.ScaledDisplayRectangle), x)
    [<CustomOperation("ScaledDisplayRectangle'")>] member inline this.ScaledDisplayRectangle' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.ScaledDisplayRectangle), x)
    ...
    [<CustomOperation("SizeEx")>] member inline this.SizeEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.Size), x)
    [<CustomOperation("SizeEx'")>] member inline this.SizeEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.Size), x)
    [<CustomOperation("Size")>] member inline this.Size ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.Size), x)
    [<CustomOperation("Size'")>] member inline this.Size' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.Size), x)
...
type FormBuilder<'Element when 'Element :> Modern.Forms.Form>() =
    ...
    [<CustomOperation("TitleBarEx")>] member inline this.TitleBarEx ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder(builder, (fun x -> x.TitleBar), x)
    [<CustomOperation("TitleBarEx'")>] member inline this.TitleBarEx' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder(builder, (fun x -> x.TitleBar), x)
    [<CustomOperation("TitleBar")>] member inline this.TitleBar ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyBuilder1(builder, (fun x -> x.TitleBar), x)
    [<CustomOperation("TitleBar'")>] member inline this.TitleBar' ([<InlineIfLambda>] builder: BuildElement<'Element>, x) = this.MakeGetOnlyAdaptiveBuilder1(builder, (fun x -> x.TitleBar), x)
